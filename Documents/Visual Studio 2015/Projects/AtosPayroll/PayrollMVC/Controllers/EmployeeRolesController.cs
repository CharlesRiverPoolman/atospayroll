...
namespace PayrollMVC.Controllers
{
    public class EmployeeRolesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID,RoleName,Description,Level,CreatedBy,CreatedDate,ModifiedBy,ModifiedDate")] EmployeeRole employeeRole)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,RoleName,Description,Level,CreatedBy,CreatedDate,ModifiedBy,ModifiedDate")] EmployeeRole employeeRole)
        {
            if (ModelState.IsValid)
            {
